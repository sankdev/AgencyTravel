...
const API_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000/api/invoice';
...
export const invoiceService = {
    ...
    getInvoicesForAgency: async () => {
        ...
        return axios.get(`${API_URL}/userAgency/${userId}`, { headers: authHeader() });
    },
    getInvoicesForCustomer: async () => {
        const userId=localStorage.getItem('userId')
        return axios.get(`${API_URL}/userCustomer/${userId}`, { headers: authHeader() });
    },
